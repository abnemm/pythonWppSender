...
def enviaHoraAHora():
    ...
    for linha in linhas:
        ...
        for linha in linhas:
            ...
            for horario in horarios:
                ...
                if dataAgora>horaServidor :
                    ...
                    dados.append([tempo,horario[5],horario[6],horario[5]-horario[6],horario[7], 'X' ])
                    # mensagem = (f'{mensagem}{horario[1]}      {horario[5]}      {horario[6]}      {horario[7]}\n')           
        ...
        for var in dadosDF.index:
            mensagem.append(f"{dadosDF['HORA'][var]}   {dadosDF['PED'][var]:3}     {dadosDF['REAL'][var]:3}      {dadosDF['DIF'][var]:3}       {dadosDF['HOR'][var]:3}        {retornaStatus(dadosDF['DIF'][var]):3}")
        mensagem.append("")
...
while 1:
    ...
    # match horario:
    #     case '7:0:0', '8:0:0', '9:0:0' ,'10:0:0', '11:0:0','12:0:0','13:0:0','14:0:0','15:0:0','15:48:0', '8:30:0':
